...
export const TradesTable = ({ rows }: { rows: BacktestSample[] }) => (
  <DashCard
    title="Trade History"
    subtitle={`${rows.length} evaluated samples`}
          ...
          {rows.map((r, i) => (
            ...
            >
              ...
              <td className="px-3 py-3">
                <DirectionBadge direction={r.prediction} />
              </td>
              <td className="px-3 py-3">
                <DirectionBadge direction={r.actual} />
              </td>
              ...
              <td className="px-3 py-3 text-right">
                {r.correct ? (
                  <span className="inline-flex whitespace-nowrap items-center gap-1 rounded-md bg-bullish/15 px-2 py-1 text-xs font-semibold text-bullish">
                    <Check className="h-3.5 w-3.5" /> Correct
                  </span>
                ) : (
                  <span className="inline-flex whitespace-nowrap items-center gap-1 rounded-md bg-bearish/15 px-2 py-1 text-xs font-semibold text-bearish">
